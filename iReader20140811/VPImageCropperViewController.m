...
- (id)initWithImage:(UIImage *)originalImage cropFrame:(CGRect)cropFrame limitScaleRatio:(NSInteger)limitRatio {
    self = [super init];
    if (self) {
        self.cropFrame = cropFrame;//裁剪后的Frame, 320 * 320 黄色框那个
        NSLog(@"self.cropFrame is %@",NSStringFromCGRect(self.cropFrame));
...
- (void)initView {
    ...
    [self.showImgView setMultipleTouchEnabled:YES];// 这有啥用呢？
...
//    [self.showImgView setMultipleTouchEnabled:YES];
    ...
    self.oldFrame = CGRectMake(oriX, oriY, oriWidth, oriHeight);//拍照之后，得到的frame
    NSLog(@"self.oldFrame is %@",NSStringFromCGRect(self.oldFrame));
    self.latestFrame = self.oldFrame;
    self.showImgView.frame = self.oldFrame;
    
    self.largeFrame = CGRectMake(0, 0, self.limitRatio * self.oldFrame.size.width, self.limitRatio * self.oldFrame.size.height);
    NSLog(@"self.showImgView.frame is %@",NSStringFromCGRect(self.showImgView.frame));
    ...
    NSLog(@"self.overlayView.frame is %@",NSStringFromCGRect(self.overlayView.frame));
    ...
    NSLog(@"self.ratioView.frame is %@",NSStringFromCGRect(self.ratioView.frame));
...
- (void)overlayClipping
{
    ...
    NSLog(@"Left is %@",NSStringFromCGRect(CGRectMake(0, 0,
    ...
    NSLog(@"Right is %@",NSStringFromCGRect(CGRectMake(self.ratioView.frame.origin.x + self.ratioView.frame.size.width,
                                                      0,
    ...
    NSLog(@"Top is %@",NSStringFromCGRect(CGRectMake(0, 0,
    ...
    NSLog(@"Bottom is %@",NSStringFromCGRect(CGRectMake(0,
