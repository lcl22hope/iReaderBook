//
//  CLDynamicTableViewController.m
//  DynamiInfo
//
...
@implementation CLDynamicTableViewController
...
-(CLPathCover*)albumHeaderContainerViewPathCover
{
    if (!_albumHeaderContainerViewPathCover) {
        CGRect albumHeaderFrame = CGRectMake(0, 64, CGRectGetWidth(self.view.bounds), 200);
