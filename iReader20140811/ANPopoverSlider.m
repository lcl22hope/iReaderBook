...
//    NSLog(@"%@",NSStringFromCGRect(_popupView.frame));
...
-(void)positionAndUpdatePopupView {
    ...
    _popupView.frame = CGRectInset(popupRect, -10, 0);//以popupRect为中心,dx,dy分别代表靠近中心，或是远离中心，正值为靠近，负值远离
...
//    NSLog(@"thumbR is %@",NSStringFromCGRect(thumbR));
    return thumbR;
}
