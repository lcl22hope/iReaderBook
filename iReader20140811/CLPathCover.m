...
#import "CLWaterDropRefresh.h"

NSString *const CLUserNameKey = @"CLUserName";
...
@property (nonatomic, strong) CLWaterDropRefresh *waterDropRefresh;

@property (nonatomic, assign) CGFloat showUserInfoViewOffsetHeight;

@end

@implementation CLPathCover
...
- (void)setInfo:(NSDictionary *)info {
    NSString *userName = [info valueForKey:CLUserNameKey];
    if (userName) {
...
- (void)_setup {
    ...
    _waterDropRefresh = [[CLWaterDropRefresh alloc] initWithFrame:CGRectMake(33, CGRectGetHeight(self.bounds) - waterDropRefreshHeight, waterDropRefreshWidth, waterDropRefreshHeight)];
...
//    _avatarButton.layer.cornerRadius = avatarButtonHeight / 2.0;
    
    _userNameLabel = [[UILabel alloc] initWithFrame:CGRectMake(93, 22, 207, 34)];
