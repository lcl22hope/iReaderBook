...
#import "CLViewState.h"
#import "CLZoomingImageView.h"


@interface CLImageViewer ()
...
- (void)setImageViewsFromArray:(NSArray*)views {
    ...
    for(id obj in views) {
        if([obj isKindOfClass:[UIImageView class]]) {
            ...
            CLViewState *state = [CLViewState viewStateForView:view];
...
- (void)dismissWithAnimate {
    ...
    [UIView animateWithDuration:0.3
                     animations:^{
                         ...
                         CLViewState *state = [CLViewState viewStateForView:currentView];
                     ...
                     completion:^(BOOL finished) {
                         ...
                         for (UIView *view in _imgViews) {
                             CLViewState *_state = [CLViewState viewStateForView:view];
